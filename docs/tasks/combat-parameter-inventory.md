...
| `wolf` | sector / 85 / `.45π` | .95 / .30 / .16 / .60s | dash corridor / 125 / `.35π` | 预告 .70 / 锁向 .25 / 距离 150 / 速度 360/s / 宽 18 / 收招 .80s |
...
| `shadow_assassin` | sector / 100 / `.35π` | .80 / .30 / .16 / .55s | dash corridor / 155 / `.25π` | 预告 .55 / 锁向 .25 / 距离 180 / 速度 450/s / 宽 12 / 收招 .90s |
...
| 怪物冲刺 | 狼 `扑击`：预告 `.70s`、锁向 `.25s`、距离 `150`、速度 `360/s`、轨迹宽 `18`、收招 `.80s`；暗影刺客 `致命突刺`：`.55s/.25s/180/450/s/12/.90s`。冲刺沿实际路径检测一次命中，撞身体、墙或边界停止，不穿身 |
